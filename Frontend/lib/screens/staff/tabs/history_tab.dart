...
class _HistoryTabState extends State<HistoryTab> {
  ...
  late Future<List<dynamic>> booksFuture; // Store the future for books

  @override
  void initState() {
    super.initState();
    booksFuture = fetchBooks(); // Initialize booksFuture
  }

  Future<List<dynamic>> fetchBooks() async {
    try {
      final data = await apiService.get('/history'); // Fetch history data
      return data;
    } catch (error) {
  ...
  Future<void> refreshBooks() async {
    setState(() {
      booksFuture = fetchBooks(); // Re-fetch books on refresh
    });
  }
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      onRefresh: refreshBooks, // Attach refresh logic
                      ...
                      child: Row(
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: Image.network(
                              book['book_image'] ??
                                  'https://via.placeholder.com/100x120', // Fallback to a placeholder image
                              width: 100,
                              height: 120,
                              fit: BoxFit.cover,
